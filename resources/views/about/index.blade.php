...
@section('page.title', 'Про нас Шкварка-Shop')

@section('main.content')
<h1 style="font-weight: bold; color: black">Про нас</h1>
<div class="post-show-text" style="line-height: 1.6; margin: 20px 0; text-align: justify;">
    <p><strong>Шкварка-shop</strong> - рідне смачне задоволення!</p>
    <p>Ми - маленька сімейна компанія, що пропонує <strong>широкий асортимент</strong>  свіжої, якісної та натуральної <strong>продукції родом з України</strong>.
        Наша місія - наповнити душу ностальгічним спокоєм, а шлунок - гастрономічним задоволенням.
    </p>
    <p>Наш асортимент покликаний задовольнити всі ваші смаки - <strong>домашнє сало</strong>, <strong>м'ясо</strong>, <strong>бочок</strong>, <strong>риба</strong>, <strong>солодощі</strong>, <strong>спеції</strong> та <strong>соуси</strong> - все це ми зібрали для вас в одному місці.</p>
    <p><strong>Для наших клієнтів ми працюємо:</strong></p>
    <ul style="margin-left: 20px;">
        <li><strong>Онлайн:</strong> щодня з 9:00 до 21:00</li>
        <li><strong>Особисто:</strong> щонеділі</li>
    </ul>
</div>

<div class="post-show-text" style="line-height: 1.6; margin-top: 30px;">
    
    <p style="padding-left: 10px; padding-top 5px;">
        <i class="bi bi-telephone-fill" style="font-size: 20px;"></i>
        <strong>Телефон:</strong> +48 784 407 399
    </p>
    <p><svg class="social-icon" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30" height="30" viewBox="0,0,256,256">
        ...
        <strong>Viber:</strong>
        <a href="viber://add?number=48784407399">Написати в Viber</a>
    </p>
    <p><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="40" height="30" viewBox="0,0,256,256">
    ...
    <p> <svg class="social-icon" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30" height="30" viewBox="0,0,256,256">
        ...
        <strong>Instagram:</strong> <a href="https://www.instagram.com/shkvarka_shop/">Перейти до профілю</a>
    </p>
</div>
@endsection
