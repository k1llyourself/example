...
<footer class="footer">
    ...
    <div class="social-strip">
        <a href="https://www.facebook.com/groups/482577181100489">
            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="50" height="30" viewBox="0,0,256,256">
        ...
        <a href="viber://add?number=48784407399">
            <svg class="social-icon" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="40" height="30" viewBox="0,0,256,256">
        ...
        <a href="https://www.instagram.com/shkvarka_shop/">
            <svg class="social-icon" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="40" height="30" viewBox="0,0,256,256">
    ...
    <div class="footer-content">
        ...
        <div class="footer-column">
            ...
            <ul>
                ...
                <li><a href="{{ route('about-us') }}" class="nav-link">
                    Про нас
                </a></li>
                <li><a href="{{ route('contacts') }}" class="nav-link   ">
                    Контакти
                </a></li>
        ...
        <div class="footer-column">
            <h4>Контакти</h4>
             <p><i class="bi bi-telephone-fill" style="font-size: 20px;"></i>  +48 784 407 399</p>
            <p><i class="bi bi-clock-fill" style="font-size: 20px;"></i>    Години роботи:</p>
